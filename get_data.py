...
class HouseSearch:
    def __init__(self):
        # if the file is empty making a req to live web and creating a file, if not empty than reading from it.
        try:
            ...
            # requesting a live data from zillow web, than saving it in txt file, so we don't have make requests
            # during testing
